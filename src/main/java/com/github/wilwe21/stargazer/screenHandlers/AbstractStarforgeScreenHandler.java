...
public class AbstractStarforgeScreenHandler extends ScreenHandler {
    ...
    final Inventory input = new SimpleInventory(2) {
        ...
        public void markDirty() {
            super.markDirty();
            AbstractStarforgeScreenHandler.this.onContentChanged(this);
        }
    };
    private final ScreenHandlerContext context;

    public AbstractStarforgeScreenHandler(int syncId, PlayerInventory playerInventory) {
    ...
    public AbstractStarforgeScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
        ...
        this.addSlot(new Slot(this.result, 2, 129, 34) {
            ...
            public void onTakeItem(PlayerEntity player, ItemStack stack) {
                ...
                AbstractStarforgeScreenHandler.this.input.setStack(0, ItemStack.EMPTY);
                AbstractStarforgeScreenHandler.this.input.setStack(1, ItemStack.EMPTY);
            }

            private int getExperience(World world) {
                int i = 0;
                i += this.getExperience(AbstractStarforgeScreenHandler.this.input.getStack(0));
                i += this.getExperience(AbstractStarforgeScreenHandler.this.input.getStack(1));
                if (i > 0) {
    ...
    public boolean canUse(PlayerEntity player) {
        return canUse(this.context, player, MoonRocks.STAR_FORGE);
    }
