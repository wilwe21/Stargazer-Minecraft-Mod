...
import com.github.wilwe21.celeste.render.DreamRenderLayer;
...
public class DreamBlockEntityRenderer<T extends DreamBlockEntity> implements BlockEntityRenderer<T> {
    public static final Identifier DREAM_TEXTURE = Identifier.of(Celeste.MOD_ID, "textures/block/dream_block.png");

    public DreamBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
    }
